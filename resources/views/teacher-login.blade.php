...
<html class="full" lang="en">
    <head>
        <title>
            Student Information System - Teacher's Login 
        </title>
                ...
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <div class="login-panel panel panel-primary">
                        <div class="panel-heading">
                            <strong><i class="fa fa-user fa-lg"></i> Teacher's Login</strong>
                    ...
                    <p class="text-center"><a href="{{ route('home') }}" class="btn btn-primary btn-xs">Back to Home</a></p>
                </div>
            </div>
        </div>
        {{-- jQuery --}}
